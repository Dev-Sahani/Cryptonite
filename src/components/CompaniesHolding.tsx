...
export default async function CompaniesHolding({
  coin,
  className,
  minimalist = false,
}: Props) {
    ...
    <Table className="text-base sm:text-lg text-center xl:text-sm">
      ...
      <TableHeader className="bg-secondary font-semibold">
        <TableRow>
          <TableHead></TableHead>
          <TableHead
            className={hide("text-primary text-left hidden lg:table-cell")}
          >
            Symbol
          </TableHead>
          ...
          <TableHead className={hide("text-primary text-center")}>
            Entry Value
          </TableHead>
          <TableHead className={hide("text-primary text-center")}>
            Current Value
      ...
      <TableBody>
        {companiesData.companies?.map((company, index) => (
          <TableRow key={company.symbol} className="relative">
            ...
            <TableCell
              className={hide(
                "text-base xl:text-sm text-left hidden lg:table-cell"
              )}
            >
              {company.symbol.split(":")[1]}
            </TableCell>
            <TableCell className="text-left lg:text-center xl:text-left xl:font-semibold">
              {company.name}
            </TableCell>
            ...
            <TableCell className={hide("hidden lg:table-cell")}>
